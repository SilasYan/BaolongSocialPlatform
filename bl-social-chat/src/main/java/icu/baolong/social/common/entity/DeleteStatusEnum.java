package icu.baolong.social.common.entity;
...
public enum DeleteStatusEnum {
	...
	private static final Map<Integer, DeleteStatusEnum> CACHE;

	static {
		CACHE = Arrays.stream(DeleteStatusEnum.values()).collect(Collectors.toMap(DeleteStatusEnum::getKey, Function.identity()));
	}
