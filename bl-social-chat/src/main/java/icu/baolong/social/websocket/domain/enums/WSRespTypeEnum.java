...
import icu.baolong.social.websocket.domain.response.CaptchaResp;
import icu.baolong.social.websocket.domain.response.LoginSuccessResp;
import icu.baolong.social.websocket.domain.response.MessageResp;
import icu.baolong.social.websocket.domain.response.OnlineOfflineNotifyResp;
import icu.baolong.social.websocket.domain.response.QRCodeResp;
...
public enum WSRespTypeEnum {
	...
	LOGIN_QR_CODE_URL(1, "登录二维码地址", QRCodeResp.class),
